    ...
    return (
      ...
      >
        <div className="rounded-3xl bg-card border border-border p-10 text-center shadow-[var(--shadow-leaf)]">
          <div
            className="h-20 w-20 mx-auto rounded-3xl flex items-center justify-center text-primary-foreground"
          ...
          <p className="text-muted-foreground mt-2">
            ...
            <span className="font-semibold text-foreground">
              {member1 && member2 ? `${member1} & ${member2}` : username}
            </span>
            , your responses have been recorded.
          </p>
          <div className="mt-6 rounded-xl bg-muted/50 border border-border p-4 text-sm text-muted-foreground">
            You've already completed{" "}
            <span className="font-semibold text-foreground">{quiz.title}</span>. Each candidate may
            attempt this exam only once.
            <br />
      ...
      <div className="rounded-3xl bg-card border border-border p-8 shadow-[var(--shadow-leaf)]">
        ...
        {quiz.instructions && (
          <div className="mt-6">
            ...
            <div className="text-sm text-foreground/90 whitespace-pre-line border-l-2 border-primary/50 pl-4 leading-relaxed">
              {quiz.instructions}
            </div>
          </div>
        )}
        ...
        <div className="mt-6 rounded-2xl bg-warning/10 border border-warning/30 p-5 text-sm">
          ...
          <ul className="mt-2 space-y-1.5 text-muted-foreground">
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span> The exam runs in{" "}
              <b className="text-foreground">fullscreen mode</b>.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span> Switching tabs, losing focus or going
              back triggers warnings.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span> After{" "}
              <b className="text-foreground">3 warnings</b> the exam is auto-submitted.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span> You can attempt this exam{" "}
              <b className="text-foreground">only once</b>.
            </li>
          </ul>
        </div>
