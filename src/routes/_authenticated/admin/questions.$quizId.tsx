...
const emptyOneWord = (quiz_id: string, pos: number): Q => ({
  quiz_id, question_type: "one_word", question_text: "",
  option_a: null, option_b: null, option_c: null, option_d: null,
  correct_answer: "", marks: 2, position: pos,
});
...
function QuestionsPage() {
  ...
  const downloadTemplate = () => {
    const rows = [
      ...
      { question_type: "one_word", question_text: "What is the capital of Saudi Arabia?", option_a: "", option_b: "", option_c: "", option_d: "", correct_answer: "Riyadh", marks: 2 },
    ...
    try {
      ...
      for (const row of data) {
        ...
        if (isMcq) {
          ...
          payload.push({
            quiz_id: quizId, question_type: "one_word", question_text: qt,
            option_a: null, option_b: null, option_c: null, option_d: null,
            correct_answer: String(row.correct_answer || "").trim(), marks, position: pos++,
          });
        } else {
          payload.push({
    ...
    <div className="p-8 max-w-4xl">
          ...
          <div key={q.id} className="rounded-2xl border border-border bg-card p-5">
            <div className="flex items-start justify-between gap-2">
              <div>
                <span className="text-[10px] uppercase tracking-widest px-2 py-0.5 rounded-full bg-primary/10 text-primary font-semibold">
                  {q.question_type === "mcq" ? "MCQ (Optional)" : q.question_type === "one_word" ? "One Word" : "Descriptive"}
                </span>
            ...
            {q.question_type === "one_word" && (
              <div className="mt-3 text-sm flex items-center gap-2">
                ...
                <span className="font-mono bg-success/10 text-success px-2.5 py-1 rounded-md font-semibold text-xs">{q.correct_answer}</span>
              </div>
            )}
      ...
      <div className="mt-8 rounded-2xl border border-border bg-card p-6">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <button onClick={() => switchType("one_word")}
        ...
        <div className="mt-4 space-y-3">
          ...
          {draft.question_type === "one_word" && (
            <div>
              ...
              <Input placeholder="e.g. Riyadh" value={draft.correct_answer ?? ""} onChange={(e) => setDraft({ ...draft, correct_answer: e.target.value })} />
              <div className="text-xs text-muted-foreground mt-1">
                Candidates must type this word. Auto-grading will check case-insensitively and trim spaces.
              </div>
            </div>
          )}
          ...
          {editingQuestion && (
            <div className="mt-4 space-y-4">
              <div className="flex flex-wrap gap-2">
                <button onClick={() => switchEditType("mcq")}
                ...
                <button onClick={() => switchEditType("one_word")}
                ...
                <button onClick={() => switchEditType("descriptive")}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditingQuestion({ ...editingQuestion, position: Number(e.target.value) })}
                  />
                </div>
              </div>
            </div>
