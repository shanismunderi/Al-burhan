import { r as reactExports, W as jsxRuntimeExports } from "./server-qf1JXDzt.mjs";
import { s as supabase } from "./client-NeI7WRgn.mjs";
import { f as formatDisplayName } from "./router-DzvbJLgE.mjs";
import { U as Users } from "./users-CbSwskku.mjs";
import { C as CircleCheck } from "./circle-check-BAyKW_q_.mjs";
import { T as TriangleAlert } from "./triangle-alert-DLcvMfLJ.mjs";
import { c as createLucideIcon } from "./createLucideIcon-DIy0_6kc.mjs";
import { A as AnimatePresence, V as VideoOff, C as Clock } from "./video-off-BCH3hWCc.mjs";
import { m as motion } from "./proxy-DXW-Uqga.mjs";
...
function AdminCameraFeed({
  attempt,
  isOnline
}) {
  const [remoteStream, setRemoteStream] = reactExports.useState(null);
  const [isLiveVideo, setIsLiveVideo] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    if (videoRef.current) {
      ...
      if (remoteStream) {
        videoRef.current.play().catch((err) => console.warn("[WebRTC-Admin] Autoplay stream failed:", err));
      }
    }
  }, [remoteStream]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-2xl border ${attempt.warnings >= 2 ? "border-destructive bg-destructive/5" : "border-border bg-card"} overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-col`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video bg-zinc-950 relative overflow-hidden flex items-center justify-center", children: [
      isLiveVideo && remoteStream ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, autoPlay: true, playsInline: true, muted: true, className: "w-full h-full object-cover scale-x-[-1] transition-all duration-300" }) }) : attempt.camera_snapshot && attempt.camera_snapshot !== "simulated" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: attempt.camera_snapshot, className: `w-full h-full object-cover scale-x-[-1] transition-all duration-300 ${!isOnline ? "opacity-40 blur-[2px]" : "opacity-100"}`, alt: "Candidate Proctor Snapshot" }),
        !isOnline && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-black/60 backdrop-blur-[1px] z-20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[7px] text-muted-foreground mt-0.5 font-mono", children: [
            "Last updated:",
            " ",
            attempt.camera_updated_at ? new Date(attempt.camera_updated_at).toLocaleTimeString() : "never"
          ] })
        ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-bold text-emerald-400 uppercase tracking-widest z-10", children: attempt.camera_snapshot === "simulated" ? "SECURE FEED ACTIVE" : "SIGNALING TUNNEL..." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[8px] text-muted-foreground mt-0.5 z-10", children: attempt.camera_snapshot === "simulated" ? "Face scanning & tracking simulated" : "Waiting for student camera feed..." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2.5 left-2.5 flex items-center gap-1.5 bg-black/60 px-2 py-0.5 rounded-md text-[8px] font-bold z-20", children: isLiveVideo && remoteStream ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-emerald-500 animate-ping" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400 font-black", children: "LIVE VIDEO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "|" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400 font-mono", children: "1080p" })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "|" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emerald-400", children: "SNAPSHOT" })
      ...
      attempt.warnings > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-2.5 right-2.5 bg-destructive/95 text-destructive-foreground px-2 py-0.5 rounded-md text-[8px] font-bold flex items-center gap-1 z-20 animate-bounce", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex-1 flex flex-col justify-between bg-muted/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-semibold text-sm truncate max-w-[130px]", children: attempt.candidate }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[9px] bg-muted px-1.5 py-0.5 rounded border border-border text-muted-foreground", children: attempt.access_code || "no code" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground mt-0.5 truncate", children: attempt.quiz_title })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 pt-3 border-t border-border flex items-center justify-between text-[9px] font-mono", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `h-1.5 w-1.5 rounded-full ${attempt.status === "in_progress" ? "bg-emerald-400 animate-pulse" : "bg-zinc-400"}` }),
          attempt.status.toUpperCase().replace("_", " ")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "EYES:",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("b", { className: attempt.warnings >= 2 ? "text-destructive" : "text-emerald-400", children: attempt.warnings >= 2 ? "UNSTEADY" : "LOCKED" })
        ] })
      ] })
    ] })
  ] });
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-[2fr_1fr] gap-6 mt-6 md:mt-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-card border border-border overflow-hidden", children: [
        ...
        viewMode === "camera" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          ...
          attempts.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsx(AdminCameraFeed, { attempt: a, isOnline: isCameraOnline(a) }, a.id)),
