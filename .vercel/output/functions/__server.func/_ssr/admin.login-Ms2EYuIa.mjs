...
import { u as useAuth, a as useNavigate, t as toast, L as Link, b as signInWithUsername } from "./router-DzvbJLgE.mjs";
import { u as useServerFn, s as seedAdmin } from "./admin.functions-BNCjYsUj.mjs";
...
import "./createLucideIcon-DIy0_6kc.mjs";
function AdminLogin() {
  const {
    session,
    role,
