...
import { s as supabase } from "./client-CQFIE6gy.mjs";
import { f as formatDisplayName } from "./router-DWG96E5D.mjs";
import { U as Users } from "./users-C3W0KKuL.mjs";
import { C as CircleCheck } from "./circle-check-Dca0BYIc.mjs";
import { T as TriangleAlert } from "./triangle-alert-CRtAMlRn.mjs";
import { c as createLucideIcon } from "./createLucideIcon-Dw1gcGK6.mjs";
import { A as AnimatePresence, V as VideoOff, C as Clock } from "./video-off-wy4iHrah.mjs";
...
function LiveDashboard() {
  ...
  reactExports.useEffect(() => {
    refresh();
    const channel = supabase.channel("admin-monitor").on("postgres_changes", {
      event: "*",
      schema: "public",
      table: "quiz_attempts"
