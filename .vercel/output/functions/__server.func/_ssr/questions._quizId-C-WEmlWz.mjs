...
import { e as Route2, L as Link, t as toast, d as cn } from "./router-DzvbJLgE.mjs";
...
import { T as Textarea } from "./textarea-C6HWTRQs.mjs";
import { R as Root, P as Portal, C as Content, a as Close, b as Title, O as Overlay, D as Description } from "./index-T2ID4id9.mjs";
import { X } from "./x-DOSGypgB.mjs";
import { a as Pencil, T as Trash2, P as Plus, A as AlertDialog, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-BtFxE8WT.mjs";
...
function QuestionsPage() {
  ...
  const add = async () => {
    ...
    setDraft((d) => (d.question_type === "descriptive" ? emptyDesc : d.question_type === "one_word" ? emptyOneWord : emptyMcq)(quizId, list.length + 1));
    load();
  };
  const remove = (id) => {
    if (!id) return;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 max-w-4xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTargetId, onOpenChange: (open) => !open && setDeleteTargetId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "Are you sure you want to delete this question? This action cannot be undone." })
      ] }),
