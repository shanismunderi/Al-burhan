...
const $$splitComponentImporter$d = () => import("./login-CguWotmF.mjs");
const Route$d = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("../_authenticated-C1JxZovu.mjs");
const Route$c = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const logoHero = "/assets/logo-hero-BfZPLwnb.png";
const $$splitComponentImporter$b = () => import("./index-CYHmYWMG.mjs");
