...
import { R as Route$1, a as useNavigate, u as useAuth, t as toast } from "./router-BcO78Wsw.mjs";
import { s as supabase } from "./client-Crz2Xt2e.mjs";
import { B as Button } from "./button-EbpQ9Y5m.mjs";
import { T as Textarea } from "./textarea-1Q4A-tPy.mjs";
import { I as Input } from "./input-DcCeYavH.mjs";
import { m as motion } from "./proxy-DVMPGLt-.mjs";
import { S as ShieldCheck } from "./shield-check-BAnX-_Or.mjs";
import { V as VideoOff, C as Clock, A as AnimatePresence } from "./video-off-XMRK6dcP.mjs";
import { c as createLucideIcon } from "./createLucideIcon-DGEEBEjg.mjs";
import { T as TriangleAlert } from "./triangle-alert-Cu4pYEBA.mjs";
import { S as Shield } from "./shield-CqpBpoSj.mjs";
