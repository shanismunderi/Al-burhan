...
import { u as useAuth, a as useNavigate, t as toast, L as Link, b as signInWithUsername } from "./router-CN2u0P4S.mjs";
import { u as useServerFn, s as seedAdmin } from "./admin.functions-B1VQUMDe.mjs";
...
import "./createLucideIcon-DBZhycyH.mjs";
function AdminLogin() {
  const {
    session,
    role,
