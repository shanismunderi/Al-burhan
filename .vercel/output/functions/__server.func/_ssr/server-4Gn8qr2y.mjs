...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BpI6_VRO.mjs");
...
const manifest = {
  "1c1583497f995205ce5444e47a5be1195de5b3e97977272800e2c658d36b7d8d": {
    ...
    importer: () => import("./db.functions-BNFE4oVX.mjs")
  },
  ...
  "2fc3d0678c31e1968563f9e2fd85c10e9366fde8c2f17ea546ae46d4afaf8a0a": {
    ...
    importer: () => import("./admin.functions-Cfl0mZBG.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-f9iG_t3k.mjs").then((n2) => n2.h),
    import("./start-Di3uYX9I.mjs"),
