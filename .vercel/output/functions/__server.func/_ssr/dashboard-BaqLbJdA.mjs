...
import { s as supabase } from "./client-DnazBy01.mjs";
import { f as formatDisplayName } from "./router-CID7cxwH.mjs";
import { U as Users } from "./users-DMcH4Pja.mjs";
import { C as CircleCheck } from "./circle-check-BmNsI3zU.mjs";
import { T as TriangleAlert } from "./triangle-alert-AS40UKkX.mjs";
import { c as createLucideIcon } from "./createLucideIcon-CA6JGplU.mjs";
import { A as AnimatePresence, V as VideoOff, C as Clock } from "./video-off-tTvcB9Sx.mjs";
...
function AdminCameraFeed({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-2xl border ${attempt.warnings >= 2 ? "border-destructive bg-destructive/5" : "border-border bg-card"} overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-col`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "aspect-video bg-zinc-950 relative overflow-hidden flex items-center justify-center", children: [
      isLiveVideo && remoteStream ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, autoPlay: true, playsInline: true, className: "w-full h-full object-cover scale-x-[-1] transition-all duration-300" }) }) : attempt.camera_snapshot && attempt.camera_snapshot !== "simulated" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full relative", children: [
