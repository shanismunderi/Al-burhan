    ...
    const handleUserChange = async (user) => {
      ...
      if (uid) {
        ...
        try {
          ...
          const r2 = roles?.find((x) => x.role === "admin") ? "admin" : roles?.[0]?.role ?? null;
          console.log("[AuthProvider] Resolved role:", r2);
          setRole(r2 ?? null);
          const p = profile;
...
const $$splitComponentImporter$d = () => import("./login-DVzO9rzy.mjs");
const Route$d = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("../_authenticated-Bfe7jT2l.mjs");
const Route$c = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const logoHero = "/assets/logo-hero-BfZPLwnb.png";
const $$splitComponentImporter$b = () => import("./index-CeZVSKpD.mjs");
...
const $$splitComponentImporter$a = () => import("./admin.login-DRSZPtlp.mjs");
const Route$a = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./participant-BdHZeR5L.mjs");
const Route$9 = createFileRoute("/_authenticated/participant")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./admin-DDlNjlBc.mjs");
const Route$8 = createFileRoute("/_authenticated/admin")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./dashboard-DGGajNH9.mjs");
const Route$7 = createFileRoute("/_authenticated/participant/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./results-BBNOWDvY.mjs");
const Route$6 = createFileRoute("/_authenticated/admin/results")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./quizzes-CvBWKIA2.mjs");
const Route$5 = createFileRoute("/_authenticated/admin/quizzes")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./participants-C8v2Uevj.mjs");
const Route$4 = createFileRoute("/_authenticated/admin/participants")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./dashboard-Cs2Ni27l.mjs");
const Route$3 = createFileRoute("/_authenticated/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./result._attemptId-S6ELMtI2.mjs");
const Route$2 = createFileRoute("/_authenticated/participant/result/$attemptId")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./quiz._quizId-BgLe868R.mjs");
const Route$1 = createFileRoute("/_authenticated/participant/quiz/$quizId")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./questions._quizId-i-FMX_Lu.mjs");
const Route2 = createFileRoute("/_authenticated/admin/questions/$quizId")({
...
const AuthenticatedAdminQuestionsQuizIdRoute = Route2.update({
  id: "/questions/$quizId",
