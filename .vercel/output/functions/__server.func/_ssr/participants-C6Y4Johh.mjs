...
import { u as useServerFn, c as createParticipant, a as updateAccessCode, d as deleteParticipant } from "./admin.functions-BNCjYsUj.mjs";
import { s as supabase } from "./client-NeI7WRgn.mjs";
import { B as Button } from "./button-DHtjwsPc.mjs";
import { I as Input } from "./input-XybSobnp.mjs";
import { L as Label } from "./label-DaZGI2bk.mjs";
import { f as formatDisplayName, t as toast } from "./router-DzvbJLgE.mjs";
import { P as Plus, a as Pencil, T as Trash2, A as AlertDialog, b as AlertDialogContent, c as AlertDialogHeader, d as AlertDialogTitle, e as AlertDialogDescription, f as AlertDialogFooter, g as AlertDialogCancel, h as AlertDialogAction } from "./alert-dialog-BtFxE8WT.mjs";
import { U as Users } from "./users-CbSwskku.mjs";
import { c as createLucideIcon } from "./createLucideIcon-DIy0_6kc.mjs";
import { C as Check } from "./check-Cer3BH9_.mjs";
import { X } from "./x-DOSGypgB.mjs";
import { K as KeyRound } from "./key-round-CwgPA8vT.mjs";
...
import "./index-BkF_v2o_.mjs";
import "./index-8t0CqQsB.mjs";
import "./index-T2ID4id9.mjs";
import "./index-C_bgpMQN.mjs";
const __iconNode = [
...
function ParticipantsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 md:p-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteTargetId, onOpenChange: (open) => !open && setDeleteTargetId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete Candidate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "Are you sure you want to delete this candidate and all their attempts? This action cannot be undone." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { onClick: handleRemove, className: "bg-destructive text-destructive-foreground hover:bg-destructive/90", children: "Delete" })
      ] })
    ] }) })
  ] });
}
