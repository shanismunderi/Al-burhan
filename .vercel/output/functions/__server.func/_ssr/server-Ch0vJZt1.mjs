...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BjRvvJJO.mjs");
...
const manifest = {
  "1c1583497f995205ce5444e47a5be1195de5b3e97977272800e2c658d36b7d8d": {
    ...
    importer: () => import("./db.functions-D35OLo_G.mjs")
  },
  ...
  "2fc3d0678c31e1968563f9e2fd85c10e9366fde8c2f17ea546ae46d4afaf8a0a": {
    ...
    importer: () => import("./admin.functions-DX6H0C1d.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CYdX2XWb.mjs").then((n2) => n2.h),
    import("./start-DCiqJPkg.mjs"),
